                    ...
                    <div class="page-header">
                        <div class="page-title">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Web Tracker Categories</li>
                            </ol>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-title">
                                <h4>Web Tracker Categories List </h4>
                                        ...
                                        @if(isset($items))
                                            @foreach($items as $k => $item)
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="{{ route('admin.tracker-categories.view', $item->id) }}" class="btn btn-success btn-flat btn-addon m-l-5" >
                                                            <i class="ti-eye"></i>
                                                            View
                                                        </a>
                                                    </td>
